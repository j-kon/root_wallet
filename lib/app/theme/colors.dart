...
abstract final class AppColors {
  ...
  static const backgroundDark = Color(0xFF071310);
  static const backgroundTintDark = Color(0xFF0D1D19);
  static const surface = Color(0xFFFFFFFF);
  static const surfaceMuted = Color(0xFFEDF4F0);
  static const surfaceRaised = Color(0xFFF9FBFA);
  static const surfaceDark = Color(0xFF0E1A17);
  static const surfaceMutedDark = Color(0xFF122521);
  static const surfaceRaisedDark = Color(0xFF162924);
  static const border = Color(0xFFD7E3DC);
  static const borderDark = Color(0xFF28453D);
  ...
  static const textSecondaryDark = Color(0xFFA4B8B0);
